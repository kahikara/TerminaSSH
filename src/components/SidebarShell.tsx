...
export default function SidebarShell({
  ...
  return (
    ...
    >
      <div className="flex-1 overflow-y-auto pt-3 pb-2 px-3 flex flex-col gap-3 min-h-0">
        {children}
      </div>

      <div className="p-3 border-t border-[color-mix(in_srgb,var(--border-subtle)_72%,transparent)] shrink-0">
        <div className={`flex ${isCollapsed ? 'flex-col items-center gap-2' : 'items-center justify-center gap-2'}`}>
          <button
            onClick={onGoHome}
