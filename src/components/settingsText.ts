...
export function getSettingsUi(lang: string) {
  if (lang === "de") {
    return {
      ...
      securityDesc: "Vault Schutz für gespeicherte Secrets.",
      ...
      showFileBrowserStatusBarLabelDesc: "Blendet die Statusleiste unten in SFTP und Local File Browser ein oder aus.",
      ...
      backupDescTitle: "Backup für Einstellungen, Verbindungen und Schlüssel.",
      about: "About",
  ...
  return {
    ...
    securityTitle: "Security",
    securityDesc: "Vault protection for stored secrets.",
    securityStatusLabel: "Vault status",
    ...
    showFileBrowserStatusBarLabelDesc: "Shows or hides the status bar at the bottom of the SFTP and local file browsers.",
    ...
    backupDescTitle: "Backup for settings, connections, and keys.",
    about: "About",
